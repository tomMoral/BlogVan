                ...
                <script>
                    ...
                    $(document).ready(function() {
                        ...
                        if (nbComments<?php echo $row['id']; ?> > 1 && hMax<?php echo $row['id']; ?> + 200 < h<?php echo $row['id']; ?>) {
                            $("#asside_<?php echo $row['id']; ?>").prepend("<div class=\"display_comment\"><div class='logo_container' id='logo_com'><img src ='images/plus.png'/></div><div  class='text_container_plus'><?php echo_trad("show all comments"); ?></div></div>");
                        ...
                        $("#asside_<?php echo $row['id']; ?> .display_comment").click(function() {
                            if (disp_all) {
                                $(this).html("<div class='logo_container' id='logo_com'><img src ='images/plus.png'/></div><div  class='text_container_plus'><?php echo_trad("show all comments"); ?></div>");
                                var i = 0;
                                toogle(<?php echo $row['id']; ?>, 0, nbCommentstoHide<?php echo $row['id']; ?>, true);
                                disp_all = false;
                            } else {
                                $(this).html("<div class='logo_container' id='logo_com'><img src ='images/minus.png'/></div><div  class='text_container_plus'><?php echo_trad("hide comments"); ?></div>");
                                var i = 0;
